...
module.exports.run = async ({ api, event, args, client, Users, Threads, __GLOBAL, Currencies }) => {
  ...
  if (money < 5000) api.sendMessage("Bạn cần 5000 đô để xem nude?", event.threadID, event.messageID)
    ...
    var callback = () => api.sendMessage({ body: `Ảnh nude\n» Số dư: -5000 đô «`, attachment: fs.createReadStream(__dirname + "/cache/nude.jpg") }, event.threadID, (err, info) => setTimeout(() => api.unsendMessage(info.messageID), 5000), event.messageID, () => fs.unlinkSync(__dirname + "/cache/nude.jpg"));
