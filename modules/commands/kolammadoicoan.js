...
module.exports.handleEvent = async({ event, api }) => {
    ...
    var arr = ["ăn cứt", "ăn cut", "huấn đạo lý", "huandaoly", "ko làm mà đòi có ăn", "ăn db", "ăn đb", "Ăn db", "Ăn đb", "Ăn cut", "Huandaoly","andb","Andb","ancut","ancut","ănđb","Ănđb","ăncut","Ăncut","kolammadoicoan","Kolammadoicoan"];
