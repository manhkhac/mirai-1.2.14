...
module.exports.run = async({ event, api, args, Currencies, Users }) => {
    ...
    return api.sendMessage(`Bạn có 15 giây để trả lời ===\n ${value1} ${operation} ${value2} = ?`, event.threadID, (err, info) => global.client.reply.push({ type: "domath", messageID: info.messageID, target: parseInt(threadID), author: senderID, answer }), event.messageID);
}