...
module.exports.run = async ({ event, api, args, Users }) => {
  try {
    ...
    const background = await Canvas.loadImage('https://raw.githubusercontent.com/manhkhac/mirai-1.2.8/data/img/coffee.jpg');
    ...
    return api.sendMessage({ attachment: fs.createReadStream(dog, { 'highWaterMark': 128 * 1024 }), body: "..." }, event.threadID, () => fs.unlinkSync(dog), event.messageID);
  }
