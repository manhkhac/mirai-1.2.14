module.exports.config = {
	...
	hasPermssion: 0,
	credits: "Quốc Anh", 
	description: "12 thì trong tiếng Anh: công thức, cách dùng và dấu hiệu nhận biết",
	...
	switch(event.body){
		case "1":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/12thi/1.jpg`)
		...
		case "3":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/12thi/3.jpg`)
			}, event.threadID, event.messageID); 
			break;
		case "4":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/12thi/4.jpg`)
			}, event.threadID, event.messageID); 
			break;
		case "5":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/12thi/5.jpg`)
			}, event.threadID, event.messageID); 
			break;
		case "6":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/12thi/6.jpg`)
			}, event.threadID, event.messageID); 
			break;
		case "7":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/12thi/7.jpg`)
			}, event.threadID, event.messageID); 
			break;
		case "8":
			api.sendMessage({
		...
		case "9":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/12thi/9.jpg`)
			}, event.threadID, event.messageID); 
			break;
		case "10":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/12thi/10.jpg`)
			}, event.threadID, event.messageID); 
			break;
		case "11":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/12thi/11.jpg`)
			}, event.threadID, event.messageID); 
			break;
		case "12":
			api.sendMessage({
...
/*module.exports.handleEvent = function({ api, event}) {
	if (event.body.indexOf("12 thì trong tiếng anh")==0 || (event.body.indexOf("12 thì trong tiếng anh")==0)) {
		api.sendMessage({
			...
			attachment: fs.createReadStream(__dirname + `/noprefix/12thi.jpg`)
